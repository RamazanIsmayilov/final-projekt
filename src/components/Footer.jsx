    ...
    <>
      <div className="footer">
        <div className="container">
          <footer className="row row-cols-1 row-cols-sm-2 row-cols-md-5 py-5 mt-5 g-3">
            ...
            <div className="center col-12 col-sm-12 col-md-6 col-lg-3">
            ...
            <div className="right col-12 col-sm-12 col-md-6 col-lg-2">
              <h4>SHARE:</h4>
