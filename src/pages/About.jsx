                ...
                <div className="py-5">
                  ...
                  <div className="py-4">
                    <div className="row d-flex align-items-center flex-lg-row-reverse">
                      <div className="col-12 col-sm-12 col-md-5 col-lg-6" data-aos="fade-left">
                      ...
                      <div className="col-12 col-sm-12 col-md-5 col-lg-6" data-aos="fade-right">
