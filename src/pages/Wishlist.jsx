    ...
    <div className="wishlistpage">
      ...
      <div className="wishlist">
        <div className="container">
          <div className="title">
            <h2 className='d-flex align-items-center justify-content-center pt-5 pb-3 fw-bold'>Wishlist(3)</h2>
          </div>
              ...
              <tbody>
                {items.map(item => (
                  <tr>
                    ...
                    <td className='text-center'><button className='addbtn'>Add to Cart</button></td>
                    <td className='text-center'>
                      <button className='ms-1' onClick={() => removeItem(item.id)}>
